...
public class LobbyManager : MonoBehaviour {
    ...
    private Player GetPlayer(bool isHost) {
        LobbyManager.PlayerCharacter charType = isHost ? PlayerCharacter.Human : PlayerCharacter.Fly;
        return new Player(AuthenticationService.Instance.PlayerId, null, new Dictionary<string, PlayerDataObject> {
            { KEY_PLAYER_NAME, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Public, playerName) },
            { KEY_PLAYER_CHARACTER, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Public, charType.ToString()) }
        });
    }
